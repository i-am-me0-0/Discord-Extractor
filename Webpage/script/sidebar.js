class CustomSidebar extends HTMLElement {
    ...
    render() {
        ...
        <p>Fetches a Lottie file based on the sticker ID and caches the Lottie file then displays it, to do conversion to GIF or WEBM of either a uploaded file or the cached file.</p>
